...
export default function MobileLanguageSwitcher() {
  ...
  return (
    <div className="relative inline-block">
      {/* Button */}
      <button
        onClick={() => setOpenLang((prev) => !prev)} // Mobile & click
        onMouseEnter={() => {
          if (window.innerWidth >= 768) { // Desktop hover only
      ...
      {/* Dropdown */}
      <div
        className={`absolute right-0 mt-1 w-44 bg-white text-black rounded-2xl shadow-xl py-2 z-50
