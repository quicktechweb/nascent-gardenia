      ...
      const fetchRoom = async () => {
        try {
          const res = await axios.get<Room[]>(
            "https://nascent.virtualshopbd.com/api/landingresturant/add"
          );
  ...
  <GeoPattern size={90} />
      ...
      >
        ...
        <div className="order-1 lg:order-3 flex flex-col justify-center lg:pr-10">
          <h1 className="text-[48px] sm:text-[60px] lg:text-[75px] font-serif text-[#2d2926] leading-none mb-6 lg:mb-10 text-left lg:text-right">
            {room.title}
          </h1>
