...
export default function RoomUpload() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const roomObj: RoomObject = {
        ...
        lunch: singleRoom.lunch,
        dinner: singleRoom.dinner,
      };
  ...
  roomsdata: [
    {
      ...
      const res = await axios.post("https://nascent.virtualshopbd.com/api/restaurants/resturntadd", payload);
 ...
 <label className="block mt-4">Room Short Title</label>
      ...
      <h2 className="text-3xl font-bold mt-10 mb-4">Resturant Information</h2>

      <div className="grid grid-cols-2 gap-4">
        {[
          { name: "title", label: "Room Title" },
          { name: "roomType", label: "Resturant Type" },
      ...
      <label className="block mt-4">
        Breakfast
        <textarea name="breakfast" className="input-white h-20" value={singleRoom.breakfast} onChange={handleChange} />
      </label>

      <label className="block mt-4">
        Lunch
        <textarea name="lunch" className="input-white h-20" value={singleRoom.lunch} onChange={handleChange} />
      </label>

      <label className="block mt-4">
        Dinner
        <textarea name="dinner" className="input-white h-20" value={singleRoom.dinner} onChange={handleChange} />
      </label>
