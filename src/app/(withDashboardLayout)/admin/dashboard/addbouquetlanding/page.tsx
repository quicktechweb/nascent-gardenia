...
export default function AddBouquetLanding() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await axios.post("https://nascent.virtualshopbd.com/api/landingbouquet/add", {
        title,
        description,
  ...
  return (
    <div className="w-full bg-[#e8dfd9] py-20 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto p-6 bg-white rounded-md shadow-md text-black">
        <h2 className="text-2xl font-bold mb-4">Add a bouquet</h2>
