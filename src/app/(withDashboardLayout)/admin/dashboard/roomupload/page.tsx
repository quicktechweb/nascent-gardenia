 ...
 const handleSubmit = async () => {
  try {
    ...
    const roomObj: RoomObject = {
      ...
      basicInfo: {
        bedType: singleRoom.bedType,
        size: singleRoom.size,
        capacity: Number(singleRoom.capacity),
        numberOfRooms: Number(singleRoom.numberOfRooms),
        bedSize: singleRoom.bedSize,
        floorInformation: singleRoom.floorInformation,
        view: singleRoom.view,
        checkinOut: singleRoom.checkinOut,
        extraBed: singleRoom.extraBed,
        connectingRoom: singleRoom.connectingRoom,
      },
      availableDates: [
        {
    ...
    await axios.post("https://nascent.virtualshopbd.com/api/rooms/add", payload);
...
{/* <label className="block mt-4">Hero Text</label>
 ...
 <label className="block mt-4">Room Short Title</label>
      ...
      <textarea
        ...
        placeholder="Short description..."
      /> */}
      <h2 className="text-3xl font-bold mt-10 mb-4">Room Information</h2>
